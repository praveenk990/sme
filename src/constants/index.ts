...
export const OUR_EXPERTISE = [
  ...
  },
  {
    ...
    icon: "pexels-rezwan-1216589.jpg",
    description:
      "We offer comprehensive engineering support, including drawing development, approvals, and temporary power sanction.",
  },
  {
    title: "Custom Control Panels:",
    icon: "Screenshot 2024-04-20 201125.png",
    description:
      "Our manufacturing capabilities extend to all types of control panels, customized to specific requirements.",
  },
];
...
export const WHY_US = [
  {
    ...
    answer: "Our knowledge spans design, execution, and commissioning.",
    value: "faq-1",
  },
  {
    question: "• Quality Assurance",
    answer: "We maintain the highest standards in all our activities.",
    value: "faq-2",
  },
  {
    question: "• Custom Solutions",
    answer: "We tailor our services to meet unique requirements.",
    value: "faq-3",
  },
  {
    question: "• Nationwide Presence",
    answer: "YES,Our capabilities extend across India",
    value: "faq-4",
  },
  {
    question: "• Quality Control",
    answer:
      "Our documented quality control processes guide every step of our work.",
    value: "faq-5",
  },

  {
    ...
    answer:
      "over 30 qualified and experienced staff members, we deliver excellence.",
    value: "faq-6",
  },
];
